...
class TestPysc2(unittest.TestCase):
    ...
    def test_select_from_list(self):
        def selector(e):
            return True
        l = list(self.replay.select_from_list(self.replay._replay.game_events, selector))
    ...
    def test_bar_chart_get_list(self):
        def selector(e):
            return isinstance(e, sc2reader.events.game.GetControlGroupEvent)
        event_list = list(self.replay.select_from_list(self.replay._replay.game_events, selector))
